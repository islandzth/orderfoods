        ...
        <div class="row mt-5">
            <div class="card w-100">
                    <div class="card-header">
                        @include('general_kitchen.partials.menu', ['current' => 'orders'])
                    </div>
                    <div class="card-body">
...
{{--                                                        <button data-toogle="choose_all_food"  data-kitchen_quantity="{{ isset($orderFood) ? $orderFood->order_quantity : 0 }}"--}}
{{--                                                                data-food_order_id="{{ isset($orderFood) ? $orderFood->id : 0 }}"--}}
{{--                                                                class="btn btn-success choose_all_food" type="button"> >> </button>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
                                            </div>
                                        </div>
